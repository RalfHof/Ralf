...
//   await sendButton.click();
  ...
  await inputName.sendKeys("Ralf Hofmann");
  await inputEmail.sendKeys("Ralf-H.de");
  await sendButton.click();
...
// expect(gefunden).toBe(true)
 // Beispiel Ende
  ...
  expect(await nameField.getText()).toBe("Ralf Hofmenn")
  expect(await emailField.getText()).toBe("Ralf-H.de")
